...
const TaskDetail = ({}: TaskDetailProps) => {
  return (
    ...
    <div className={`flex  mt-10`}><CommentBox CommentDate={"10/08/2022"} TotalComment={1} Name={"Linda Hsu"} CommenterAvator={""} Comments={"Hi Could you provide me the link of data?"} /></div>
