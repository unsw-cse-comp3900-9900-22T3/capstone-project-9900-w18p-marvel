    ...
    <div className={`flex flex-col w-176 h-44`}> 
        ...
        <div className={`flex item-start flex-row w-176 h-20 bg-gray-50 items-center rounded-2xl relative`}>
            <div className={`flex w-20`}>
                ...
                <input className={`placeholder:italic placeholder:text-slate-400 w-135 block bg-white h-10 border border-slate-200 rounded-sx py-2 pl-9 pr-3 focus:outline-none focus:border-sky-200 focus:ring-sky-500 focus:ring-1 sm:text-sm" `} placeholder="Write a Comment!..." type="text" name="Comments"/>
            <div className={`flex flex-row absolute right-5`}>
                <svg className={`flex text-xs text-gray-100`}>icon</svg>
            </div>
